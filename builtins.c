...
void    ft_builtins(t_core   *core)
{
    ...
    {
        if (!ft_strncmp(core->lexer->content, "echo", ft_strlen(core->lexer->content)))
            ft_echo_management(core);
        // else if (ft_strncmp(core->lexer->content, "cd", ft_strlen(core->lexer->content)))
          //  ft_cd_management(core);
        //else if (ft_strncmp(core->lexer->content, "pwd", ft_strlen(core->lexer->content)))
           // ft_pwd_management(core);
/*         else if (ft_strncmp(core->lexer->content, "unset", ft_strlen(core->lexer->content)))
            ft_unset_management(core);
        else if (ft_strncmp(core->lexer->content, "export", ft_strlen(core->lexer->content)))
            ft_export_management(core);
        else if (ft_strncmp(core->lexer->content, "env", ft_strlen(core->lexer->content)))
            ft_env_management(core); */
        else if (!ft_strncmp(core->lexer->content, "exit", ft_strlen(core->lexer->content)))
